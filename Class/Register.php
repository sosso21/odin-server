...
*/
    ...
    class Register
    {
    	...
    	public function __construct( $nom = null ,  $prenom = null ,  $email = null , $pass = null , $pass2= null  , $condition= null   )
    	{
    		...
    		if (isset($prenom , $nom , $email , $pass) ) {
    			...
    			$pdo  = new PDO($db_DSN , $db_USER , $db_PASS ) ;
    			 $request = $pdo->prepare("INSERT INTO user  ( `fname`, `lname`,`email`, `password`   ) VALUES (?, ? , ? , SHA2( ?, 256)   )" );
    			  $request->execute(array($nom , $prenom , $email , $pass ));
    	...
    	public 	function issub()
    	{
    		require(ROOTPATH.'elements'.DIRECTORY_SEPARATOR.'db_config.php');
    		$pdo  = new PDO($db_DSN , $db_USER , $db_PASS ) ;
    		$request2 = $pdo->prepare("SELECT COUNT(*) FROM user WHERE   email =?  ");
